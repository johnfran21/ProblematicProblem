...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if(lines.Length == 0)
            {
                logger.LogError("No Locations Found:");
            }
            if(lines.Length == 1)
            {
                logger.LogWarning("Only 1 Location Found:");
            }
            ...
            for (int x = 0; x < locations.Length; x++)
            {
                ...
                GeoCoordinate corA = new GeoCoordinate(locA.Location.Latitude, locA)
            }
